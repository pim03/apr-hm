...
Foi possível observar que a pureza aumenta com o aumento do número de clusters, enquanto que a silhueta diminui. 
Ou seja, os clusters estão mais sobrepostos, menos coesos e não tão bem separados o que pode significar que estamos a supersegmentar os dados, criando clusters muito pequenos ou muitos clusters.
Por outro lado, o facto da pureza aumentar com o valor de k indica que os clusters estão cada vez mais heterogéneos (com mais pontos de dados da mesma classe)  \\ \\
...
Explained variance (eigenvalues) = (0.07345, 0.02740)\\
