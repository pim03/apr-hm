...
\begin{equation}
    P_k(y_1=1) = \frac{\sum_{i=1}^4 \gamma_{ki} p(y_1=1\mathbf{x}_i)}{\sum_{i=1}^4 \gamma_{ki}} 
\end{equation}

\begin{equation}
    P_k(y_1=1) = \sum_{i=1}^4 \gamma_{ki}
\end{equation}
...
\begin{equation*}
    p(\mathbf{x}_{new}) = 0.09667
\end{equation*}

\begin{equation*}
    p(cluster = 1|\mathbf{x}_{new}) = 0.02531
\end{equation*}

\begin{equation*}
    p(cluster = 2|\mathbf{x}_{new}) = 0.97469
\end{equation*}
...
\end{equation}
SERA Q ISTO TA CERTO????
\begin{equation}
    p(\mathbf{x}_i|cluster = k) = \frac{p(\mathbf{x}_i,cluster = k)}{p(cluster = k)}
\end{equation}
...
$\mathbf{x_1}$ &  0.59941  & 1.29174 & 2 \\ \hline
$\mathbf{x_2}$ &  1.00197  & 0.25471 & 1 \\ \hline
$\mathbf{x_3}$ &   1.13789 & 1.43871 & 2 \\ \hline
$\mathbf{x_4}$ &  0.05377  & 1.26294 & 2 \\ \hline
\end{tabular}
\end{table}
...
\hline
cluster            & $x_i$ & $s(x_i)$   & $s(c_k)$                    & $s(sol)$                  \\ \hline
1                  & $x_2$  & 1       & 1                        & \multirow{4}{*}{0.61420} \\ \cline{1-4}
\multirow{3}{*}{2} & $x_1$  & 0.59259 & \multirow{3}{*}{0.22840} &                          \\ \cline{2-3}
                    & $x_3$  & -0.5    &                          &                          \\ \cline{2-3}
                    & $x_4$  & 0.59259 &                          &                          \\ \hline
\end{tabular}
\end{table}
